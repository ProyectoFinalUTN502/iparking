...
namespace iparking
{
    ...
    public class _DemoParkinglotActivity : Activity
    {
        Button btnLayout1;
        Button btnLayout2;
        Button btnLayout3;
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout._demo_parkinglot);
        ...
        private void BtnLayout3_Click(object sender, EventArgs e)
        {
            ...
            Intent intent = new Intent(this, typeof(_DemoPathfinderActivity));
